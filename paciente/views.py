...
def agendar_horario(request, id_data_aberta):
    if request.method == "GET":
        ...
        horario_agedado = Consulta(
            paciente = request.user,
            data_aberta= data_aberta
        )
        
        horario_agedado.save()
...
def consulta(request, id_consulta):
    if request.method == "GET":
        ...
        return render(request, 'consulta.html',{'is_medico':is_medico(request.user),'consulta':consulta, 'dado_medico':dado_medico})